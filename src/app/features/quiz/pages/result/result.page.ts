            ...
            <div class="accordion-body">
              <ul class="list-group">
                ...
                >
                  ...
                  <i
                    *ngIf="store.answers()[i] === q.answerIndex && j === q.answerIndex"
                    class="bi bi-check-circle-fill text-success me-2"
                  ></i>

                  <!-- Caso ERROU: opção marcada errada mostra X vermelho -->
                  <i
                    *ngIf="store.answers()[i] !== q.answerIndex && j === store.answers()[i]"
                  ...
                  <i
                    *ngIf="store.answers()[i] !== q.answerIndex && j === q.answerIndex"
                    class="bi bi-arrow-right-circle-fill text-success me-2"
                  ></i>
              ...
              <div class="mt-3 p-2 rounded bg-warning" *ngIf="q.explanation">
